...
export const vfUpdateAwbStatusDocumented = (formData: FormData) => {
...
export const vfUpdateAwbStatusPending = (formData: FormData) => {
  // Validate form using Zod
...
export const vfUpdateAwbStatusDelivered = (formData: FormData) => {
  // Validate form using Zod
