...
export const vfCreateAwbIndividualStatusDocumented = (formData: FormData) => {
...
export const vfCreateAwbIndividualStatusPending = (formData: FormData) => {
  // Validate form using Zod
...
export const vfCreateAwbIndividualStatusDelivered = (formData: FormData) => {
  // Validate form using Zod
