...
const Card = ({
  ...
  return (
    <>
      <div className="max-w-[200px] overflow-hidden rounded-lg border-t-[1px] border-gray-200 bg-white shadow-sm shadow-gray-400 md:max-w-xs">
        <img className="w-full" src={data.image} alt="Charles Nwodo jnr" />
